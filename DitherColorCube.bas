        ...
        If delta_x >= (1 / 256) Then
            ...
            While col < draw_max_x
                ...
                If Screen_Z_Buffer(zbuf_index) = 0.0 Or tex_z < Screen_Z_Buffer(zbuf_index) Then
                    ...
                    RGB_Dither555 col, row, RGB_Fog&(tex_z, RGB_Lit&(dotProdLightDir, RGB_Modulate&(ReadTexel&(tex_u * tex_z, tex_v * tex_z), _RGB(tex_r, tex_g, tex_b))))
